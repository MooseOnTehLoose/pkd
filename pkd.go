...
func up(modifier string) {
	...
	//we no longer use a separate kib as of DKP 2.5, it is part of the "everything" airgap bundle
...
// DKP 2.4.0 and up no longer use separate resources for airgap bundle
